...
{
    public class DefModExt_Biome_GenStep_BetterCaves : DefModExt
	{

		public float chanceToGenerate = 1f;
		...
		public List<TerrainThreshold> terrainPatchMakerCaveGravel = null;

		public bool GenerateOnTile(int tile)
		{
			return Rand.ValueSeeded(tile) < this.chanceToGenerate;
		}
	}
}
