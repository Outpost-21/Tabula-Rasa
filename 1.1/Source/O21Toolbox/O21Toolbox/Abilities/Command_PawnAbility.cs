...
namespace O21Toolbox.Abilities
{
    ...
    {
        public Comp_AbilityUser compAbilityUser;
        public int curTicks = -1;
        public PawnAbility pawnAbility;
        public Verb_UseAbility verb = null;

        public Command_PawnAbility(Comp_AbilityUser compAbilityUser, PawnAbility ability, int ticks)
        {
        ...
        public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth)
        {
            ...
            if (DoTooltip)
            {
                ...
                if (disabled && !disabledReason.NullOrEmpty())
                    tip.text = tip.text + "\n" + StringsToTranslate.O21_AU_DISABLED + ": " + disabledReason;
