...
namespace O21Toolbox.Networks
{
    public class CompProperties_CustomNetwork : CompProperties
    {
        ...
        public override IEnumerable<StatDrawEntry> SpecialDisplayStats(StatRequest req)
        {
            ...
            {
                yield return new StatDrawEntry(StatCategoryDefOf.Building, "Network Consumption: ".ToString(), this.baseNetworkConsumption.ToString("F0") + this.networkDef.networkMeasurement);
            }
            yield break;
        }
    }
