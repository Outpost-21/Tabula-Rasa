    ...
    public class WorkGiver_GiveEnergySourceConsumableToPatient : WorkGiver_Scanner
    {
        ...
        public override Job JobOnThing(Pawn pawn, Thing thing, bool forced = false)
        {
            ...
            if(closestEnergySource != null)
            {
                ...
                Comp_EnergySource energySourceComp = closestEnergySource.TryGetComp<Comp_EnergySource>();
                ...
                if (thingCount > 0)
                    return new Job(JobDefOf.O21RechargeEnergyComp, new LocalTargetInfo(closestEnergySource), new LocalTargetInfo(targetPawn))
                    {
                        count = thingCount
                    };
            }
