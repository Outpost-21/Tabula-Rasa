...
namespace O21Toolbox.ThingProducer
{
    public class Building_ThingProducer : Building
    {
        ...
        public override IEnumerable<FloatMenuOption> GetFloatMenuOptions(Pawn myPawn)
        {
            ...
            {
                FloatMenuOption item3 = new FloatMenuOption("No available " + this.producerProps.thingDef.label, (Action)null, MenuOptionPriority.Default, (Action)null, null, 0f, (Func<Rect, bool>)null, null);
                return new List<FloatMenuOption>
                {
                    item3
                };
