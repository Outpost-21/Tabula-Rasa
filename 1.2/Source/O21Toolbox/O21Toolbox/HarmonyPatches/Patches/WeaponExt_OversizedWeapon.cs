...
namespace O21Toolbox.HarmonyPatches.Patches
{
    ...
    public class DrawEquipmentAimingPreFix
    {
        [HarmonyPrefix]
        public static bool refix(PawnRenderer __instance, Thing eq, Vector3 drawLoc, float aimAngle)
        {
            if (eq is ThingWithComps thingWithComps)
            {
                ...
                var compOversizedWeapon = thingWithComps.TryGetComp<Comp_OversizedWeapon>();
        ...
        private static float AdjustOffsetAtPeace(Thing eq, Pawn pawn, Comp_OversizedWeapon compOversizedWeapon, float num)
        {
            Mesh mesh;
            mesh = MeshPool.plane10;
        ...
        private static float AdjustNonCombatRotation(Pawn pawn, float num, Comp_OversizedWeapon compOversizedWeapon)
        {
        ...
        private static Vector3 AdjustRenderOffsetFromDir(Pawn pawn, Comp_OversizedWeapon compOversizedWeapon)
        {
    ...
    public class get_Graphic_PostFix
    {
        [HarmonyPostfix]
