...
namespace O21Toolbox.Abilities
{
    ...
    {
        public Comp_AbilityUser abilityUser; //public for resolving saving / loading issues between versions
        private Pawn pawn;
        ...
        public PawnAbility(Comp_AbilityUser comp)
        {
        ...
        {
            pawn = data.Pawn;
            abilityUser = data.Pawn.AllComps.FirstOrDefault(x => x.GetType() == data.AbilityClass) as Comp_AbilityUser;
            //Log.Message("PawnAbility Created: " + this.Def.defName);
        }
        ...
        public virtual Comp_AbilityUser AbilityUser
        {
            get
            {
                if (abilityUser == null)
                    abilityUser = (Comp_AbilityUser)pawn.AllComps.FirstOrDefault(x => x is Comp_AbilityUser);
                return abilityUser;
            }
        }
