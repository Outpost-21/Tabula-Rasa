...
namespace TabulaRasa
{
    public class IncidentWorker_CustomMeteoriteStrike : IncidentWorker
	{
		...
		{
			return CellFinderLoose.TryFindSkyfallerCell(skyfaller, map, TerrainAffordanceDefOf.Heavy, out cell, alwaysAvoidColonists: true, allowCellsWithBuildings: false, allowCellsWithItems: false, allowRoofedCells: false);
		}
	}
}
