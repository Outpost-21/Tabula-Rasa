...
namespace TabulaRasa
{
    public class Comp_PawnSpawner : ThingComp
    {
        ...
        public void SpawnPawn()
        {
            ...
            PawnGenerationRequest request = new PawnGenerationRequest(kind: Props.pawnKind, faction: Faction.OfPlayer, fixedBiologicalAge: newborn, forceGenerateNewPawn: true, canGeneratePawnRelations: Props.canGeneratePawnRelations);
